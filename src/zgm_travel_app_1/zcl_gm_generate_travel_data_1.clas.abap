CLASS zcl_gm_generate_travel_data_1 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_GM_GENERATE_TRAVEL_DATA_1 IMPLEMENTATION.
...
*   delete existing entries in the database table
    DELETE FROM zgm_travel1.

*   insert the new table entries
    INSERT zgm_travel1 FROM TABLE @itab.
